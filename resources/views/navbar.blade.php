...
<nav class="row">
    ...
    <div class="col-xs-4">
        <ul id="menu_connect">
            <li class="menu_share"><a href="{{ route('newSpot') }}" class="menu_lien_share"><span class="hidden-sm hidden-xs" id="menu_share_letter">Partager </span><i class="fa fa-camera-retro" aria-hidden="true" id="menu_share_icon"></i></a></li>
